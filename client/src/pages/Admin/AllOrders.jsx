...
const AllOrders = () => {
  ...
  const filteredOrders = orders.filter((order) => {
    ...
    return (
      ...
      order.waiterId?.name?.toLowerCase().includes(searchLower)
    );
  });
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {selectedOrder.status === 'in-kitchen' && (
                      <button
                        ...
                        className="px-4 py-2.5 bg-green-500 text-white rounded-lg hover:bg-green-600 font-semibold transition shadow-sm"
                      >
                        Mark Ready
                      </button>
                    )}
